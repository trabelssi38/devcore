...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-14 (commit 6512a54). Confidence: 100%.
...
- `DEV_CORE/docs/PLATFORM_DOCUMENTATION.md` — 101 commits/90d (99.3th %ile)
...
### Code health
Three co-equal signals: defect risk 7.74/10 avg, hotspot health 5.55/10 (stable), worst `DEV_CORE/Scripts/Auto/task_prompt_analyzer.py` at 1.65/10 · maintainability 9.42/10 · performance risk 32 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `DEV_CORE/Scripts/task_sync.ps1` — untested hotspot — impact −2.0
