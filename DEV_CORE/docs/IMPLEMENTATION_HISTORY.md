...
| T-372 (2026-08-13) | Portabilité & Migration Vectorielle SQLite (v10.3.10) | Résolution Python dynamique `Get-DevCorePython`, correction redirections `2>$null` -> `2>&1`, regex chemins universelles `[/\\]Scripts[/\\]?$`, élimination chemins codés en dur, et remplacement complet des dépendances/pings de port legacy Qdrant par le moteur natif `sqlite-vec`. |
