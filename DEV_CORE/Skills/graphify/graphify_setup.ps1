# graphify_setup.ps1 -- DEV_CORE v6
...
Write-Host ""
Write-Host "  DEV_CORE v6 -- Graphify Setup" -ForegroundColor Cyan
...
Write-Host "  [OK] Graphify installe dans DEV_CORE v6    " -ForegroundColor Green
Write-Host "  ============================================" -ForegroundColor Green
Write-Host ""
