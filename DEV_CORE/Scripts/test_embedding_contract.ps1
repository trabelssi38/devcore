# Delegator wrapper for Python unittest test_embedding_contract.py
...
& $pythonExe -m unittest (Join-Path $DEV_CORE "devcore_engine/tests/test_embedding_contract.py")
exit $LASTEXITCODE
