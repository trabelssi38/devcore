# Delegator wrapper for Python unittest test_qdrant_vector_contract.py
...
& $pythonExe -m unittest (Join-Path $DEV_CORE "devcore_engine/tests/test_qdrant_vector_contract.py")
exit $LASTEXITCODE
