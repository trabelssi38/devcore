...
- [ ] `S0-01` — Créer `dc verify --ci` avec sortie JSON et code non nul fiable. `5 pts`
- [ ] `S0-02` — Corriger les tests qui affichent FAIL mais retournent `0`. `3 pts`
...
- [ ] `S1-01` — Écouter sur `127.0.0.1` par défaut et rendre le bind explicite. `2 pts`
- [ ] `S1-02` — Ajouter authentification locale et rotation des tokens. `5 pts`
...
- [ ] `S3-05` — Générer OpenAPI et un client TypeScript. `3 pts`
- [ ] `S3-06` — Ajouter contract tests et politique de versioning. `1 pt`
...
- [ ] `S4-05` — Mettre en place dual-read contrôlé puis cutover. `3 pts`
- [ ] `S4-06` — Ajouter backup, restore et test de migration descendante. `2 pts`
...
- [ ] `S5-01` — Définir la machine d'état Run et ses transitions. `4 pts`
- [ ] `S5-02` — Extraire un worker d'exécution hors du processus HTTP. `5 pts`
- [ ] `S5-03` — Ajouter outbox transactionnelle et consommateurs idempotents. `5 pts`
...
- [ ] `S6-01` — Instrumenter API, services et workers avec OpenTelemetry. `5 pts`
