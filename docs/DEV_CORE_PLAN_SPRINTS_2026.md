...
- [x] `S7-06` — Ajouter tests composants et E2E Playwright. `3 pts`
...
- [x] `S8-02` — Ajouter scopes filesystem/network/secrets/process. `5 pts`
...
- [x] `S9-02` — Implémenter rôles owner/admin/developer/viewer. `4 pts`
...
- [x] `S10-04` — Créer templates de workflows versionnés. `4 pts`
- [x] `S10-05` — Construire onboarding, diagnostic et recovery guidés. `3 pts`
- [x] `S10-06` — Publier documentation API et guide opérateur. `3 pts`
...
- [x] `S11-06` — Runbook incidents et critères de support. `3 pts`
